...
const int system_call_length = 1000;
...
diff_dump_status analitical_latex_dump(const diff_node_t* node, const diff_node_t* diffed_node, 
                                       const dvalue_t* derivative_value_buffer, const int degree, const dvalue_t variable, const char* file_name, const char* output_directory);
diff_dump_status latex_dump(const diff_node_t* node, const char* file, const char* output_directory);
